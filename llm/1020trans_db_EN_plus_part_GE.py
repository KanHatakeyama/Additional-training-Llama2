...
base_path = "res/1020trans_db_EN_plus_part_GE/"
r = 64
lr = 2*10**-4
total_epochs = 5
train_dataset_path = ""
test_dataset_path = "../smallDB/1018ig/oa_qa.json"
context_path = "../database/output/1019translatable_EN_plus_part_GE.json"
...
base_path = prepare_base_path(base_path, r, full_lora, m_name)
# print(key)
...
if do_original_eval:
    eval_path = original_base_path+f"_{m_name}.csv"
