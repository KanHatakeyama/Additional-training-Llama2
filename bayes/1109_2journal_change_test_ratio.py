...
proj_name = "1109change_ds_ratio2"
...
train_num_cond_list = []
for tr_context_nums in [1, 100, 1000, 10000, 200000]:
    # for tr_instruction_nums in [0]:
    for tr_instruction_nums in [1, 100, 1000, 10000, 45000]:
