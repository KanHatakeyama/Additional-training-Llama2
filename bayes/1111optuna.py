...
def objective(trial):
    ...
    n_mmlu_instructions = trial.suggest_int(
        "n_mmlu_instructions", 1, len(mmlu_instruction_dataset), log=True)
    ...
    optuna_score = (score-0.1)*np.log10(n_texts)
...
study = optuna.create_study(
    direction='maximize', storage=f'sqlite:///optuna_oa_{model_size}.db',
