...
dataset_conditions = {
    ...
    #                 ],
    #                ],
    # "QA": ["../database/1103output/train.json",
    #       [
    #       ],
    #       ],
}
...
train_num_cond_list = []
for tr_context_nums in [0, 100, 1000, 10000, 200000]:
    # for tr_instruction_nums in [0]:
    for tr_instruction_nums in [0, 100, 1000, 10000, 50000]:
    ...
    for bit in [
        ...
        for c_train in train_num_cond_list:
            ...
            for dataset_cond in dataset_conditions:
                ...
                train_dict["total_epochs"] = 5
                train_dict["inner_epochs"] = 3
